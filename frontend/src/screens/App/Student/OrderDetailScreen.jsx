        ...
        {order && (
          <>
            {returnStatus === "paid" && order.status === "paid" && (
              <div style={{ background: "var(--status-success-bg)", border: "1px solid var(--status-success-solid)", borderRadius: 10, padding: "12px 16px", marginBottom: 16, color: "var(--status-success-fg)", fontWeight: 600 }}>
                ✓ Payment successful — your access is unlocked.
              </div>
            )}
            {returnStatus === "failed" && (
              <div style={{ background: "var(--status-danger-bg)", border: "1px solid var(--status-danger-solid)", borderRadius: 10, padding: "12px 16px", marginBottom: 16, color: "var(--status-danger-fg)", fontWeight: 600 }}>
            ...
            <div style={{ background: "#fff", border: "1px solid var(--border)", borderRadius: 14, overflow: "hidden" }}>
              ...
              <div style={{ padding: "20px 24px" }}>
                ...
                {order.couponDiscount > 0 && (
                  <div style={{ display: "flex", justifyContent: "space-between", color: "var(--status-success-fg)", fontSize: 14 }}>
